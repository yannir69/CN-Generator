...
def generate():
    ...
    agent_profi = Agent(
        ...
        backstory = 'Dein Kommentarstil ist professionell, sachlich, und auf Fakten basiert. Deine Antworten sollen immer auf Deutsch sein.',
        verbose = True,
        #allow_delegation = False,
        language = 'de'
    )
    ...
    agent_humor = Agent(
        role = 'Moderator eines Accounts auf einer Social Media Plattform',
        goal = 'Generator von deutschen Antworten auf gegebene Hasskommentare, um weitere Hassrede in der Kommentarspalte zu verringern. Verwende ausschließlich die deutsche Sprache für die Antwort.',
        backstory = 'Dein Kommentarstil ist humorvoll, kreativ und schlagfertig. Benutze Emojis um den Humor hervorzuheben. Deine Antworten sollen immer auf Deutsch sein.',
        verbose = True,
        #allow_delegation = False,
        language = 'de'
    )
    ...
    agent_affection = Agent(
        role = 'Moderator eines Accounts auf einer Social Media Plattform',
        goal = 'Generator von deutschen Antworten auf gegebene Hasskommentare, um weitere Hassrede in der Kommentarspalte zu verringern. Verwende ausschließlich die deutsche Sprache für die Antwort.',
        backstory = 'Dein Kommentarstil ist einfühlsam und sensibel. Versuche die Ansichtsweise des Hassredners anzuerkennen, aber freundlich zu widerlegen. Deine Antworten sollen immer auf Deutsch sein.',
        verbose = True,
        #allow_delegation = False,
        language = 'de'
    )
    ...
    """crew = Crew(
        agents = [agent_profi, agent_affection, agent_humor, agent_problem, agent_evaluator],
        tasks = [task_profi, task_affection, task_humor, task_problem, task_evaluation],
        verbose = 2,
        temperature = 0.6,
        language = 'de',
